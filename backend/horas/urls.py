...
urlpatterns = [
    ...
    path('verdatosbuscar/',views.verdatosbuscar, name="verdatosbuscar"),
    path('mostrarempleado/<int:afiliado>/',views.mostrarempleado, name="mostrarempleado"),
    path('tipodecarga/', views.tipodecarga, name="tipodecarga"),
